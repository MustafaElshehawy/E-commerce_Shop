...
/*----------------------------------------*/
	$(function () {
		$('[data-countdown]').each(function () {
			var $this = $(this);
			var finalDate = $this.data('countdown'); // بيقرأ القيمة من data-countdown

			$this.countdown(finalDate, function (event) {
				$this.html(
					event.strftime(
						'<div class="count">%D <span>Days:</span></div> ' +
						'<div class="count">%H <span>Hours:</span></div> ' +
						'<div class="count">%M <span>Mins:</span></div> ' +
						'<div class="count">%S <span>Secs</span></div>'
					)
				);
			}).on('finish.countdown', function () {
				// اختيارى: ماذا يحدث عند انتهاء الوقت؟ (مثلاً إخفاء العداد)
				$(this).html('<div class="expired">Offer Ended!</div>');
			});
		});
	});
/*----------------------------------------*/
